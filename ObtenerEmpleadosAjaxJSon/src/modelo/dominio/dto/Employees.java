 ...
 */
public class Employees extends ObjectDTO implements java.io.Serializable,Comparable {
	...
	public String toString(){
		return "Me llamo " + this.firstName;
	}

	@Override
	public int compareTo(Object o) {
		Employees emplo = (Employees) o;
		return emplo.getSalary().compareTo(this.salary);
	}
	...
	public boolean equals(Object o) {
		...
		Employees emplo = (Employees) o;
		iguales = (emplo.getEmployeeId() == this.employeeId);
		return iguales;
	}
